...
public class ApiServiceController {
    ...
    public ResponseEntity<?> execService() throws InterruptedException {
        ...
        if (valorExecution > 0){
            ...
            return new ResponseEntity("Executando a API service 1", HttpStatus.OK);
        }else
            return new ResponseEntity( "Ocorreu um erro na execução do serviço API service 1", HttpStatus.INTERNAL_SERVER_ERROR);
