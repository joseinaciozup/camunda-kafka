...
@Component
public class ServiceTaskWorkerController3 implements JavaDelegate {

    private final String url = "http://localhost:8089/worker-controller-3";
    private final String A = "A";
    private final String STEP = "step";
    private final String DIRECTION_A = "directionA";
    private final String DIRECTION_B = "directionB";
    private final String TIME = "time3";
