...
@Component
public class ServiceTaskWorkerController1 implements JavaDelegate {

    private final String url = "http://localhost:8087/worker-controller-1";
    private final String A = "A";
    private final String STEP = "step";
    private final String DIRECTION_A = "directionA";
    private final String DIRECTION_B = "directionB";
    private final String TIME = "time1";
